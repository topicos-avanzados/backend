...
public class JwtTokenUtil implements Serializable {
  ...
  public static final long JWT_TOKEN_MAIL_VALIDITY = 5 * 24 * 60 * 60;
  ...
  public String generateMailToken(UserDetails userDetails, Boolean admin, Long company) {
    Map<String, Object> claims = new HashMap<>();
    claims.put("admin", admin);
    claims.put("company", company);
    return doGenerateMailToken(claims, userDetails.getUsername());
  }

  private String doGenerateMailToken(Map<String, Object> claims, String subject) {
    ...
    return Jwts
        ...
        .setSubject(subject)
        .setIssuedAt(new Date(System.currentTimeMillis()))
        .setExpiration(new Date(System.currentTimeMillis() + JWT_TOKEN_MAIL_VALIDITY * 1000))
        .signWith(SignatureAlgorithm.HS512, secret)
        .compact();
  }
